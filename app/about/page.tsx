  ...
  return (
    <div className="flex flex-col gap-20 pb-24 md:gap-28">
      <PageHero
        ...
        description="동양구조엔지니어링은 구조설계부터 안전점검·진단, 공사 중 안전관리, 해체공사 구조검토까지 건축물의 생애주기 전반에 필요한 구조 엔지니어링 서비스를 제공합니다. 정확한 기술 검토와 책임 있는 판단, 고객과의 지속적인 소통을 바탕으로 더 안전하고 합리적인 해답을 제시합니다."
      />
