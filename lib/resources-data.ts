...
export const resources: Resource[] = [
  ...
  {
    slug: "ai-agent-advanced-features",
    category: "기술 가이드",
    title: "06. AI 코딩 에이전트를 더 깊이 쓰는 법",
    summary:
      "AI에게 일을 맡기기 전 계획을 세우고, 작업 공간을 나누고, 결과를 확인하는 방법을 쉬운 예시로 설명합니다.",
    updatedAt: "2026-09-07",
    attachments: [
      {
        name: "AGENTS_작성_예시.md",
        size: "4.5 KB",
        type: "Markdown",
        href: "/documents/AGENTS_작성_예시.md",
      },
    ],
    body: [
      {
        type: "video",
        label: "먼저 보기 · 코덱스 18가지 필수 기능 12분 정리 (코드팩토리)",
        url: "https://www.youtube.com/watch?v=86B_oGCkyMs",
        description:
          "아래 글은 이 영상에서 소개한 기능을 바탕으로, AI 코딩 도구가 익숙하지 않은 사람도 실제 업무에 적용할 수 있도록 다시 정리한 내용입니다.",
      },
      {
        type: "paragraph",
        text: "AI 코딩 에이전트는 질문에 답만 하는 챗봇과 다릅니다. 필요한 파일을 읽고, 여러 단계를 계획하고, 실제 파일을 고친 뒤, 검사 결과까지 확인할 수 있습니다. 여기서는 OpenAI Codex의 데스크톱 앱·명령줄 도구(CLI)·편집기 확장에서 사용하는 주요 기능을 설명합니다.",
      },
      {
        type: "link",
        label: "이전 글 · 05. 실무에서 사용하는 AI와 개발 도구",
        url: "/resources/ai-tools-for-work",
        description: "각 도구의 역할과 연결 순서를 먼저 다룬 글입니다.",
      },
      {
        type: "callout",
        tone: "info",
        text: "기능 이름을 모두 외울 필요는 없습니다. **계획이 필요한지, 별도 작업 공간이 필요한지, 오래 이어갈 작업인지**만 구분해도 필요한 기능을 고를 수 있습니다. 다른 AI 도구에서는 같은 목적의 기능도 이름과 동작이 다를 수 있습니다.",
      },
      {
        type: "heading",
        text: "AI에게 먼저 알려줄 네 가지",
        id: "request-basics",
      },
      {
        type: "table",
        ...
        rows: [
          [
            "목표",
            "무엇을 만들거나 바꾸려는가",
            "기술자료 글을 비개발자도 이해하기 쉽게 고친다",
          ],
          [
            "맥락",
            "어떤 파일과 자료를 참고해야 하는가",
            "현재 기술카드와 참고 영상을 함께 본다",
          ],
          [
            "제약",
            "반드시 지킬 규칙은 무엇인가",
            "회사 정보와 확인되지 않은 수치를 만들지 않는다",
          ],
          [
            "완료 조건",
            "무엇을 확인하면 끝인가",
            "글을 고치고 링크·첨부파일·빌드가 정상인지 확인한다",
          ],
        ],
      },
      {
        type: "callout",
        tone: "info",
        text: '**요청 예시:** "이 기술자료를 처음 보는 직원도 이해할 수 있게 고쳐줘. 현재 글과 영상을 참고하고, 회사 정보는 새로 만들지 마. 수정 후 링크와 빌드까지 확인해줘."',
      },
      {
        type: "heading",
        text: "계획할 때와 오래 맡길 때",
      ...
      {
        type: "table",
        headers: ["기능", "쉽게 말하면", "언제 쓰나"],
        rows: [
          [
            "플랜 모드(Plan mode)",
            "일을 시작하기 전에 순서와 방법부터 적는 기능",
            "작업 범위가 크거나 무엇부터 해야 할지 불분명할 때",
          ],
          [
            "골(Goal)",
            "완료 조건을 붙여 두고 여러 단계의 일을 계속 이어가는 기능",
            "검사와 수정이 반복되는 장시간 작업을 맡길 때",
          ],
          [
            "스티어링(Steering)",
            "일하는 중간에 새 지시를 보내 방향을 바꾸는 기능",
            "진행 중 우선순위나 요구사항이 바뀌었을 때",
          ],
          [
            "콤팩트(Compact)",
            "긴 대화를 회의 요약처럼 줄여서 계속 사용할 공간을 확보하는 기능",
            "한 대화가 길어져 이전 내용이 너무 많이 쌓였을 때",
          ],
        ],
      },
      {
        type: "paragraph",
        text: "Plan은 **어떻게 할지 먼저 정하는 단계**이고, Goal은 **정한 완료 조건까지 작업을 이어가는 방식**입니다. 간단하고 분명한 한 번의 수정에는 둘 다 필요하지 않을 수 있습니다.",
      },
      {
        type: "heading",
        text: "작업 공간과 대화를 나누는 법",
        id: "workspace",
      },
      {
        type: "table",
        headers: ["기능", "무엇을 나누나", "쉬운 비유"],
        rows: [
          [
            "워크트리(Worktree)",
            "실제 코드 파일을 별도 작업 공간에 복사해 분리",
            "원본 서류 옆에 시험용 사본을 한 벌 더 펼쳐 놓는 것",
          ],
          [
            "포크(Fork)",
            "지금까지의 대화를 복사해 새로운 대화로 분기",
            "같은 회의 내용을 가지고 두 가지 안을 따로 검토하는 것",
          ],
          [
            "사이드 채팅(Side)",
            "진행 중인 대화는 그대로 두고 임시 질문을 분리",
            "회의를 멈추지 않고 옆 사람에게 짧게 확인하는 것",
          ],
        ],
      },
      {
        type: "paragraph",
        text: "워크트리는 Git으로 관리하는 프로젝트에서 사용합니다. 보통 다른 작업에 영향을 주지 않고 시험하거나 여러 일을 동시에 진행할 때 유용합니다. 작업이 끝나면 로컬 작업 공간으로 넘겨 확인하거나, 새 브랜치를 만들어 보관하고 검토할 수 있습니다.",
      },
      {
        type: "callout",
        tone: "warning",
        text: "워크트리는 **파일 충돌을 줄이는 별도 작업대**이지 보안 공간이 아닙니다. 비밀키·개인정보·발주처 원본 자료를 넣어도 안전해지는 것은 아닙니다. 환경 설정 파일처럼 Git에서 제외한 파일은 새 작업 공간에 자동으로 복사되지 않을 수 있습니다.",
      },
      {
        type: "heading",
        text: "결과를 확인하는 리뷰",
      ...
      {
        type: "paragraph",
        text: "AI가 작업을 끝냈다고 말해도 바로 반영하지 않습니다. 먼저 검사 명령을 실행하고, 바뀐 파일을 비교한 다음, 리뷰 기능으로 빠진 문제를 한 번 더 찾습니다. 리뷰는 기본적으로 파일을 고치지 않고 문제의 위치와 이유를 알려줍니다.",
      },
      {
        type: "table",
        headers: ["검토 범위", "확인하는 내용"],
        rows: [
          ["기준 브랜치와 비교", "작업을 시작하기 전 상태와 비교해 전체 변경을 확인"],
          ["커밋하지 않은 변경", "아직 저장 이력으로 확정하지 않은 현재 작업을 확인"],
          ["특정 커밋", "한 번의 저장 이력에 들어간 변경만 확인(CLI에서 선택 가능)"],
          [
            "사용자 지정 검토",
            "보안·계산 오류·접근성처럼 직접 정한 기준으로 확인(CLI에서 선택 가능)",
          ],
        ],
      },
      {
        type: "callout",
        tone: "warning",
        text: "리뷰 기능은 실수를 줄이는 보조 수단입니다. **구조 계산, 설계기준 적용, 해석 결과와 외부 공개 자료는 담당자가 원자료와 대조해 최종 확인합니다.**",
      },
      {
        type: "heading",
        text: "모델과 대화 설정",
      ...
      {
        type: "table",
        headers: ["설정", "쉽게 말하면", "알아둘 점"],
        rows: [
          [
            "메모리(Memory)",
            "이전 대화에서 알게 된 선호나 배경을 다음 대화에도 참고",
            "반드시 지켜야 할 업무 규칙을 맡기는 곳은 아님",
          ],
          [
            "퍼스널리티(Personality)",
            "답변의 말투와 설명 방식을 선택",
            "작업 규칙이나 정확도를 바꾸는 기능은 아님",
          ],
          [
            "모델(Model)",
            "어떤 AI 모델에게 일을 맡길지 선택",
            "사용할 수 있는 모델은 계정과 제품에 따라 다를 수 있음",
          ],
          [
            "리저닝(Reasoning effort)",
            "답을 내기 전에 얼마나 깊게 검토할지 조절",
            "높일수록 복잡한 작업에 유리할 수 있지만 더 오래 걸릴 수 있음",
          ],
          [
            "Fast mode",
            "지원되는 모델의 응답을 더 빠르게 처리",
            "추가 크레딧을 사용할 수 있으며 지원하지 않는 모델에서는 보이지 않음",
          ],
          [
            "상태(Status)",
            "현재 모델·권한·대화 사용량과 작업 위치를 확인",
            "AI가 예상한 환경에서 일하는지 점검할 때 사용",
          ],
        ],
      },
      {
        type: "paragraph",
        text: "메모리는 편의를 위한 참고 정보입니다. Codex에서는 지원되는 환경에서 대화별로 메모리를 사용할지, 현재 대화를 이후 메모리 생성에 사용할지 조절할 수 있습니다. 계속 지켜야 하는 회사 규칙과 작업 방법은 아래의 AGENTS.md처럼 파일로 남기는 편이 분명합니다.",
      },
      {
        type: "heading",
        text: "외부 도구와 반복 작업 연결하기",
        id: "connections",
      },
      {
        type: "table",
        ...
        rows: [
          [
            "MCP",
            "AI가 저장소 밖의 서비스나 도구를 사용할 수 있게 연결하는 공통 규격",
            "허용된 문서 저장소나 업무 서비스의 자료 조회",
          ],
          [
            "스킬(Skill)",
            "자주 반복하는 작업 순서와 기준을 재사용할 수 있게 묶은 절차",
            "보고서 검사 순서, 기술자료 작성 형식",
          ],
          [
            "앱·플러그인",
            "필요한 스킬과 외부 연결 기능을 설치 가능한 묶음으로 제공",
            "문서·일정·저장소 서비스 연결",
          ],
        ],
      },
      {
        type: "paragraph",
        text: "영상에서는 필요한 스킬을 찾는 기능을 /find로 소개합니다. 제품이 업데이트되면서 명령 이름과 설치 방식은 달라질 수 있으므로, 현재 화면의 Skills·Plugins·Apps 메뉴에서 사용할 수 있는 항목을 확인합니다. 연결 기능은 많이 설치하기보다 실제로 반복하는 일에 필요한 것부터 하나씩 추가합니다.",
      },
      {
        type: "callout",
        tone: "warning",
        text: "외부 도구를 연결하면 AI가 접근할 수 있는 자료의 범위가 넓어집니다. 연결 전 권한을 확인하고, **발주처 원본 자료·미공개 성과품·개인정보·비밀키는 업로드하거나 외부 서비스로 보내지 않습니다.**",
      },
      {
        type: "heading",
        text: "AGENTS.md로 내 작업 규칙 알려주기",
        id: "agents-md",
      },
      {
        type: "paragraph",
        text: "AGENTS.md는 AI가 프로젝트에서 일을 시작할 때 먼저 읽는 업무 안내서입니다. 매번 같은 설명을 대화창에 반복하지 않고, 반드시 지켜야 할 규칙과 확인 방법을 파일에 적어둘 수 있습니다. 메모리가 개인의 선호를 떠올리는 메모장이라면, AGENTS.md는 해당 폴더에서 적용하는 공식 작업 지침에 가깝습니다.",
      },
      {
        type: "table",
        headers: ["작성 예시의 구역", "AI에게 알려주는 내용"],
        rows: [
          ["나에 대해", "구조설계·안전점검 같은 담당 업무와 주로 만드는 파일"],
          ["판단과 확인", "언제 질문하고, 어떤 작업은 실행 전에 확인받아야 하는지"],
          ["정확성", "KDS·KCS 인용, 숫자·날짜·금액의 출처를 어떻게 확인할지"],
          ["말투 원칙", "결론을 먼저 쓰고 과장 없이 짧게 설명하는 방식"],
          ["도구별 규칙", "한글·Excel·AutoCAD·해석 프로그램을 다룰 때 지킬 기준"],
          ["작업 후 보고", "완료한 내용, 사용한 규칙, 가정, 확인할 일을 보고하는 형식"],
        ],
      },
      {
        type: "paragraph",
        text: "글 아래의 첨부파일은 실제 구조 엔지니어링 업무에 맞춰 작성한 AGENTS.md 예시입니다. 그대로 복사하기보다 본인의 업무·폴더·사용 도구에 맞지 않는 항목을 지우고 필요한 규칙만 남겨 사용합니다.",
      },
      {
        type: "heading",
        text: "처음 써볼 때 순서",
      ...
      },
      {
        type: "list",
        items: [
          "하나 · 원하는 결과, 참고 자료, 지켜야 할 규칙, 완료 조건을 적습니다.",
          "둘 · 범위가 크거나 모호한 작업만 Plan mode로 계획부터 확인합니다.",
          "셋 · 기존 코드와 분리해 시험하려면 Worktree를 선택합니다.",
          "넷 · 같은 대화에서 두 가지 안을 비교하려면 Fork를 사용합니다.",
          "다섯 · 여러 단계의 장기 작업이면 검증 가능한 완료 조건과 함께 Goal을 설정합니다.",
          "여섯 · 진행 중 요구사항이 바뀌면 새 지시를 보내 방향을 조정합니다.",
          "일곱 · 작업이 끝나면 검사 명령, 변경 내용 비교, Review 순서로 확인합니다.",
          "여덟 · 계산 결과와 외부 공개 내용은 담당자가 원자료와 대조해 최종 확인합니다.",
        ],
      },
      {
        type: "callout",
        tone: "info",
        text: "**가장 간단한 기준:** 시작 방법이 막히면 Plan, 오래 이어가야 하면 Goal, 원본과 분리해 시험하려면 Worktree, 끝난 작업을 확인하려면 Review를 사용합니다.",
      },
    ],
    related: ["ai-tools-for-work", "ai-workflow-standardization"],
  },
];
