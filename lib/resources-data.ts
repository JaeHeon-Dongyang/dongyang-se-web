    ...
    body: [
      {
        type: "callout",
        tone: "info",
        text: "시작하기 전에 — 영상 하나: 샌드위치 만들기 (https://youtu.be/3VG2OgkRJK0). 아이들이 '샌드위치 만드는 방법'을 종이에 적고, 아빠가 그 종이에 적힌 대로만 정확히 따라 합니다. 결과는 엉망이 됩니다. 잼을 다른 손에 바르고, 빵을 통째로 뭉개고, 아이들은 답답해서 소리를 지릅니다.",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "우리가 후배에게 일을 시킬 때를 생각해 봅시다. '이 도면 보고 기둥 일람표 좀 뽑아줘.' 이 한 문장으로 대체로 일이 됩니다. 후배가 알아서 채워 넣기 때문입니다. 어느 레이어를 볼지, 기둥과 벽을 어떻게 구분할지, 표 양식은 어떤 걸 쓸지, 애매하면 물어볼지 말지 — 이 전부가 말하지 않아도 공유되는 것들입니다. 같은 사무실에서 같은 일을 해왔으니까요.",
      },
      {
        type: "paragraph",
        text: "컴퓨터에는 그게 없습니다. 우리 사무실 관행을 모릅니다. 도면을 본 적도 없고, 기둥이 뭔지도 모릅니다. '적당히'나 '알아서'라는 말을 이해하지 못합니다. 애매하게 시키면 애매하게 하는 게 아니라, 엉뚱하게 하거나 아예 멈춥니다. 샌드위치 영상의 아빠가 딱 그 상태입니다.",
      },
      {
        type: "callout",
        tone: "info",
        text: "핵심 — 개발은 머릿속에만 있던 것을 전부 밖으로 꺼내 적는 일입니다. 이게 개발의 절반 이상이고, 어려운 것도 여기입니다. 코드를 쓰는 게 어려운 게 아니라, 내가 무엇을 하고 있었는지 정확히 아는 게 어렵습니다.",
      },
