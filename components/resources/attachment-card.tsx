...
export function AttachmentCard({ attachment }: { attachment: Attachment }) {
  return (
    <a
      ...
      download
      className="border-border bg-surface hover:border-brand focus-visible:ring-accent-green flex items-center gap-4 border p-5 transition-colors focus-visible:ring-2 focus-visible:outline-none"
    >
      ...
      <span className="border-brand text-brand shrink-0 border px-3.5 py-1.5 text-xs font-semibold">
        다운로드
      </span>
    </a>
  );
