...
| # | 화면 | 경로 | 상태 |
| --- | --- | --- | --- |
| 1 | 홈 (회사소개 통합) | `/` | **구현 완료** (제공 원고 기반, 공공 자문 미검증 3건 비노출) |
| 2 | 사업분야 | `/services` | **구현 완료** |
| 3 | 기술자료 목록 | `/resources` | **구현 완료** (외부 공개, placeholder 데이터) |
| 4 | 기술자료 상세 (일반) | `/resources/[slug]` | **구현 완료** |
| 5 | PF3D 매뉴얼 상세 | `/resources/pf3d-manual` | **구현 완료** |
| 6 | 질문하기 | `/ask` | **구현 완료** (공개 안내, 비공개 노트북 링크) |
| 7 | 문의하기 | `/contact` | **구현 완료** |
| 8 | 개인정보처리방침 | `/privacy` | 초안 (내비/색인 제외) |
| 9 | 404 / 오류 | `not-found`, `error` | **구현 완료** |
