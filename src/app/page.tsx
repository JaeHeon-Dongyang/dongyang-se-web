    ...
    <>
      ...
      <section className="bg-surface">
        <Container className="py-20 sm:py-28">
          ...
          <h1 className="mt-3 max-w-3xl text-display">{company.tagline}</h1>
          <p className="mt-6 max-w-2xl text-body-lg">
            {company.name}은 구조설계, 안전진단·점검, 공사 중 안전관리와 해체공사
            구조검토를 수행하는 건축구조 전문기업입니다. 구조기술사와 시공기술사를
            포함한 전문 인력, 체계적인 협업 인프라와 지속적인 소통을 바탕으로
            안전하고 합리적인 해결책을 제공합니다.
          </p>
